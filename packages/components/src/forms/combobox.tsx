      ...
      >
        <Headless.ComboboxInput
          ...
          className={cx(
            ...
            // Disabled state
            "data-disabled:border-muted-foreground/30 data-disabled:bg-muted/20",
            // System icons
            "dark:scheme-dark",
          )}
        />
        <Headless.ComboboxButton className="group absolute inset-y-0 right-0 flex items-center px-2">
          <svg
            className="size-5 stroke-muted-foreground group-data-disabled:stroke-muted-foreground/60 group-data-hover:stroke-foreground sm:size-4 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
  ...
  return (
    <Headless.ComboboxOption
      ...
      className={cx(
        ...
        // Typography
        "text-base/6 text-popover-foreground sm:text-sm/6 forced-colors:text-[CanvasText]",
        // Focus
