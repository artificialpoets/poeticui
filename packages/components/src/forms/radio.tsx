...
const base = [
  ...
  "dark:bg-muted/30 dark:group-data-checked:bg-(--radio-checked-bg)",
  // Border
  "border border-border group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-muted-foreground/40 group-data-checked:bg-(--radio-checked-border)",
  ...
  "group-data-disabled:border-muted-foreground/30 group-data-disabled:bg-muted/30 group-data-disabled:[--radio-checked-indicator:var(--color-neutral-950)]/50 group-data-disabled:before:bg-transparent",
...
const colors = {
  "dark/zinc": [
    ...
    "dark:[--radio-checked-bg:var(--color-neutral-400)]",
  ],
  "dark/white": [
    "[--radio-checked-bg:var(--color-neutral-900)] [--radio-checked-border:var(--color-neutral-950)]/90 [--radio-checked-indicator:var(--color-white)]",
  ...
  zinc: "[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-neutral-400)] [--radio-checked-border:var(--color-neutral-700)]/90",
  ...
  blue: "[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-orange-600)] [--radio-checked-border:var(--color-orange-700)]/90",
  indigo:
